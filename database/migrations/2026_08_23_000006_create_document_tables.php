...
/**
 * Documents domain (invoices, delivery notes, their sequences and lines) —
 * consolidated baseline.
 *
 * Folds add_rendering_metadata_to_documents (seller_snapshot + template_version;
 * the historical row backfill is dropped — nothing to backfill on a fresh build)
 * and the invoice_lines unit_price_incl_tax snapshot from
 * add_public_ttc_price_and_default_tax_rate.
 */
