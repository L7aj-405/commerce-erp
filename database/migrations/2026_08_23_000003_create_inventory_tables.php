...
/**
 * Inventory domain — consolidated baseline (unchanged from create_inventory_tables;
 * already in its final form). Stock is only ever tracked through balances,
 * movements and reservations — there is no per-product stock column anywhere.
 */
